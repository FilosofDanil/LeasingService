...
public class OffersTests {
    ...
    public void getAllOffersTestWithOneFilterAndSort() throws Exception {
        this.mockMvc.perform(get("/api/v1/offers/").with(user("dru"))
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("{\"id\":7,\"title\":\"House of the rising sun\",\"postdate\":\"2023-05-15T22:00:00.000+00:00\",\"cold_arend\":100.0,\"warm_arend\":550.0,\"description\":\"Some text\",\"city\":\"Hamburg\",\"address\":\"Gercena35\",\"rooms\":1,\"area\":30.0,\"internet\":true,\"balkoon\":true,\"floor\":7,\"image_link\":\"base.png\",\"likes_link\":\"http://localhost:8080/api/likes/v1/7\",\"self_link\":\"http://localhost:8080/api/v1/offers/7\"},{\"id\":2,\"title\":\"House of the rising sun\",\"postdate\":\"2023-05-15T22:00:00.000+00:00\",\"cold_arend\":100.0,\"warm_arend\":300.0,\"description\":\"Some text\",\"city\":\"Hamburg\",\"address\":\"Gercena35\",\"rooms\":2,\"area\":32.5,\"internet\":true,\"balkoon\":true,\"floor\":2,\"image_link\":\"base.png\",\"likes_link\":\"http://localhost:8080/api/likes/v1/2\",\"self_link\":\"http://localhost:8080/api/v1/offers/2\"},{\"id\":3,\"title\":\"House of the rising sun\",\"postdate\":\"2023-05-15T22:00:00.000+00:00\",\"cold_arend\":100.0,\"warm_arend\":350.0,\"description\":\"Some text\",\"city\":\"Hamburg\",\"address\":\"Gercena35\",\"rooms\":3,\"area\":35.0,\"internet\":true,\"balkoon\":true,\"floor\":3,\"image_link\":\"base.png\",\"likes_link\":\"http://localhost:8080/api/likes/v1/3\",\"self_link\":\"http://localhost:8080/api/v1/offers/3\"},{\"id\":9,\"title\":\"House of the rising sun\",\"postdate\":\"2023-05-15T22:00:00.000+00:00\",\"cold_arend\":100.0,\"warm_arend\":650.0,\"description\":\"Some text\",\"city\":\"Hamburg\",\"address\":\"Gercena35\",\"rooms\":3,\"area\":35.0,\"internet\":true,\"balkoon\":true,\"floor\":9,\"image_link\":\"base.png\",\"likes_link\":\"http://localhost:8080/api/likes/v1/9\",\"self_link\":\"http://localhost:8080/api/v1/offers/9\"},{\"id\":11,\"title\":\"House of the rising sun\",\"postdate\":\"2023-05-15T22:00:00.000+00:00\",\"cold_arend\":100.0,\"warm_arend\":750.0,\"description\":\"Some text\",\"city\":\"Hamburg\",\"address\":\"Gercena35\",\"rooms\":2,\"area\":45.0,\"internet\":true,\"balkoon\":true,\"floor\":11,\"image_link\":\"base.png\",\"likes_link\":\"http://localhost:8080/api/likes/v1/11\",\"self_link\":\"http://localhost:8080/api/v1/offers/11\"}")));
    }

    @Test
    public void getAllOffersTestWithOneSort() throws Exception {
        this.mockMvc.perform(get("/api/v1/offers/").with(user("dru"))
                        .param("sort", "warm_arend")
                        .param("direction", "ASC"))
                .andDo(print())
                .andExpect(status().isOk())
